    ...
    <div className="max-w-3xl mx-auto py-8">
      <div className="prose prose-lg dark:prose-invert">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg mb-4">
            For Builder's Day 2025, we're going beyond words with action. We're
            putting builders on Times Square and creating the first Registry of
            Verified Onchain Builders—a decentralized directory powered by
            onchain attestations and built collectively by trusted organizations
            across the industry.
          </p>
          <p className="text-lg">
            But Builders Day is more than just a directory - it's a platform to
            recognize and empower those who are building a better tomorrow.
          </p>
        </div>
        ...
        <div className="space-y-8 bg-gradient-to-b from-background to-muted/20 p-8 rounded-lg border">
          ...
          <div className="space-y-8 text-lg leading-relaxed">
            ...
            <p className="font-medium">
              They build their own path, breaking free from the corporate mold.
              They question the norms, ignore conventions, and reimagine the
              future.
            </p>
            ...
            <p className="font-medium">
              They are driven by curiosity, not corner offices. They don't seek
              power, but to empower. They are born to build, not to be bossed
              around.
            </p>
            ...
            <p className="font-medium">
              The world might underestimate them. Mock their ideals and laugh at
              their dreams. But they keep building. Not for quick gains, but
              driven by a need for lasting change.
            </p>

            <p className="font-medium">
              This is a testament to their courage, resilience, and creativity.
              We stand beside them, following their vision, supporting their
              work. You can't quantify their impact in market cap alone, because
              their legacy is being written in immutable code.
            </p>
